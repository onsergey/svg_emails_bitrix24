...
class Sanitizer
{
	...
	protected static function getTags()
	{
		$tags = array(
			...
			'svg' => array('width','height', 'viewBox','fill','xmlns','style','id','class'),
			'path' => array('d','fill','stroke', 'stroke-width' ,'stroke-miterlimit','style','id','class'),
			'circle' => array ('cx', 'cy', 'r', 'fill', 'style','id','class'),
			'g' => array('clip-path','style','id','class'),
			'defs'=> array('style','id','class'),
			'clipPath' => array('style','id','class'),
			'rect' => array('width','height','fill','transform','style','id','class'),
